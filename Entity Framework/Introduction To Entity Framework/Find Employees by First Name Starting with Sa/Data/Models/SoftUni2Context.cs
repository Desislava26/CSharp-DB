...
namespace Find_Employees_by_First_Name_Starting_with_Sa.Data.Models
{
    public partial class SoftUni2Context : DbContext
    {
        public SoftUni2Context()
        {
        }

        public SoftUni2Context(DbContextOptions<SoftUni2Context> options)
            : base(options)
        {
        }
